...
TEST_RESULT_TABLE_HEADERS = [u'برچسب رنگی',u'سطح حساسیت',u'خروجی مورد انتظار',u'خروجی آزمون',u'شرح آزمون',u'گزینه تحت آزمون',u'نام آزمون']
...
FLOCKDN_DESCRIPTION = u"بیت \nFLOCKDN\n سطح دسترسی(خواندن/نوشتن) در ثبات \nHSFS\n و برخی دیگر از ثبات های \nکنترلی را مشخص می¬کند.\n صفر بودن آن به معنی عدم برقراری\nسطوح امنیتی است. \n(مهمترین بیتی که در این آزمون کنترل میشود)" # use \n for newlines!
...
SMM_BWP_2_DESCRIPTION = u"بیت \nSMM_BWP\n طریقه دسترسی به حافظه \nفلش دربردارنده بایوس را مشخص می کند.\n در صورتی که این بیت برابر یک باشد\nدسترسی به کدهای بایوس تنها از طریق حالت\nSMM\n امکان پذیر خواهد بود.\n در صورت عدم فعال بودن سطوح امنیتی \nPR\n می توانند جایگزین آن شوند و\nدسترسی ها را محدود کنند." # use \n for newlines!
...
TCO_SMI_LOCK_DESCRIPTION = u"اگر این بیت برابر یک باشد\nTCO\n در برابر نوشتن محافظت می شود\nو امنیت آن حفظ خواهد شد." # use \n for newlines!
...
SMI_LOCK_DESCRIPTION = u"اگر این بیت برابر یک باشد \nSMI\n در برابر نوشتن محافظت می شود\nو امنیت آن حفظ خواهد شد." # use \n for newlines!
...
Global_SMI_EN_DESCRIPTION = u"در صورت صفر بودن این بیت وقفه\n های سیستمی غیرفعال خواهند شد.\n سیستم در مقابل حملات بسیار \nحساس می شود." # use \n for newlines!
...
TCO_SMI_EN_DESCRIPTION = u"در صورتی که مقدار این\nبیت یک باشد مدار \nTCO\nامکان استفاده از وقفه های \nسیستمی را خواهد داشت." # use \n for newlines!
...
BIOS_KEYBOARD_BUFF_DESCRIPTION = u"این بافر به منظور ذخیره اولیه\nگذرواژه برای مقایسه حروف گذرواژه \nمی باشد. پس از بوت شدن سیستم باید \nاین بافر ریست شود و گذرواژه \nدرون خود را پاک کند." # use \n for newlines!
...
BIOSWE_DESCRIPTION = u"این بیت وضعیت امکان نوشتن بر\n روی حافظه بایوس را مشخص می کند.\n در صورتی که نیاز به تغییراتی در\nکدهای بایوس باشد این بیت می تواند \nبه صورت موقت یک شود." # use \n for newlines!
BIOSWE_REPR = "BIOSWE"
...
BLE_DESCRIPTION = u"بیت \nBIOSWE\n توسط این بیت محافظت می شود. \nدرخواست ها برای نوشتن بر روی حافظه\n بایوس تنها زمانی مجاز هستند \nکه این بیت برابر صفر شده و بیت \nBIOSWE\n به صورت موقت به مقدار یک تغییر کند. " # use \n for newlines!
BLE_REPR = "BLE"
...
SRC_EXPECTED_RESULT = "-"
SRC_DESCRIPTION = u"امکان خواندن تنظیمات وقفه \nهای سیستمی را فراهم می کند. \nدر اکثر پلتفرم ها این مقدار \nبرابر یک است." # use \n for newlines!
SRC_REPR = "SRC"
...
TSS_DESCRIPTION = u"این بیت در هنگام بروزرسانی \nبایوس می تواند مقدار یک \nدر خود داشته باشد." # use \n for newlines!
TSS_REPR = "TSS"
...
SMM_BWP_DESCRIPTION = u"ثباتی امنیتی برای کنترل \nنوشتن بر روی کدهای حالت \nSMM\n است. در صورت فعال نبودن \nامنیت سیستم مورد تهدید قرار می گیرد\n ولی روش های جایگزینی برای\n آن وجود دارند." # use \n for newlines!
...
D_LCK_DESCRIPTION = u"در صورت فعال بودن \nSMRAM\n که کدهای بایوس را درون خود\n نگه داری می کند، این بیت\m کاربرد خواهد داشت.\n در صورت فعال بودن این بیت،\n مقادیر آدرس های اولیه \nو فعال شدن حافظه \nSMRAM\n و ... قفل خواهند شد." # use \n for newlines!
D_LCK_REPR = "D_LCK"
...
UE_DESCRIPTION = u" زمان واقعی سیستم باید در \nبرابر نرمافزار ها محافظت شود.\nاین بیت قفل 128 بایت پایینی حافظه \nزمان واقعی سیستم را فعال می کند." # use \n for newlines!
UE_REPR = "UE"
...
LL_DESCRIPTION = u" زمان واقعی سیستم باید در \nبرابر نرمافزار ها محافظت شود.\nاین بیت قفل 128 بایت پایینی حافظه \nزمان واقعی سیستم را فعال می کند." # use \n for newlines!
LL_REPR = "LL"
...
UL_DESCRIPTION = u" زمان واقعی سیستم باید در \nبرابر نرمافزار ها محافظت شود.\nاین بیت قفل 128 بایت پایینی حافظه \nزمان واقعی سیستم را فعال می کند." # use \n for newlines!
UL_REPR = "UL"
...
IA32_Lock_DESCRIPTION = u"این بیت نقش قفل کننده \nنوشتن بر روی برخی ثبات های \nMSR\n را بر عهده دارد. این بیت \nباید همواره برابر یک باشد." # use \n for newlines!
IA32_Lock_REPR = "Lock"
...
BBRA_BBWA_DESCRIPTION = u"دسترسی به هر ناحیه امنیتی \nدر حافظه های فلش باید به \nگونه ای باشد که کدهای مربوط به \nبایوس، امضای دیجیتال سیستم\n و ... برای همه نرم افزار ها قابل \nدسترس نباشند و محدودیت صحیح اعمال شود. \nدر این آزمون در صورتی که مقادیر \nمجاز ناحیه ها بر قرار نباشند، \nاین مسئله را هشدار خواهد داد." # use \n for newlines!
...
FDOPSS_DESCRIPTION = u"این بیت از توصیف گر \nحافظه فلش در برابر باز \nپیکربندی محافظت می کند." # use \n for newlines!
FDOPSS_REPR = "FDOPSS"
...
BILD_DESCRIPTION = u"در صورتی که مقدار \nاین بیت برابر یک نباشد، \nBios Interface \nقفل نبوده و امکان دسترسی \nبه آن وجود دارد." # use \n for newlines!
BILD_REPR = "BILD"
...
TSS_2_DESCRIPTION = u"این بیت نباید به مدت زیادی\nبرابر یک باشد و تنها در\nزمان به روزرسانی باید \nمقدار یک به خود بگیرد." # use \n for newlines!
TSS_2_REPR = "TSS"
...
SMRR_range_base_DESCRIPTION = u"حد بالای آدرس های محافظت شده توسط \nSMRR\n را مشخص میکند. باید مقدار صحیحی\n داشته باشد." # use \n for newlines!
...
SMRR_range_mask_DESCRIPTION = u"حد بالای آدرس های محافظت شده توسط \nSMRR\n را مشخص میکند. باید مقدار صحیحی\n داشته باشد." # use \n for newlines!
...
SMRR_range_base_and_mask_are_same_DESCRIPTION = u"به ازای تمامی \ncore\n ها مقادیر \nSMRR\n باید در حدود مجاز باشند." # use \n for newlines!
...
IA32_SMRR_PHYSBASE_DESCRIPTION = u"در صورتی که این ثبات در \nمحدوده مجاز نباشد حمله کننده می تواند\n برای دسترسی به بخشی از فضای \nSMRAM\n مقادیر \nTSEG\nرا تغییر دهد." # use \n for newlines!
...
SMMR_PROTECTION_AGAINST_CACHE_ATTACK_DESCRIPTION = u"محافظت از حافظه\nSMMR\n در برابر حملات حافظه کش.\n در صورت فعال نبودن حمله\nکننده با استفاده از حافظه\n کش می تواند فابل های آلوده\n را برای بوت سیستم بارگزاری کند." # use \n for newlines!
...
RemapWindowConfig_DESCRIPTION = u"مقادیر \nLimit\n و \nBase\n و \nTOUUD\n را چک می کند.\n در صورتی که مقدار \nCorrect\n بازگردانده شود به معنای آن \nاست که بدافزاری مقادیر را\n غیر مجاز نکرده است." # use \n for newlines!
...
TOUUD_DESCRIPTION = u"باید مقدار مجاز داشته\n باشد و حد بالایی دسترسی ها در \nMemory Remapping\n را مشخص کند." # use \n for newlines!
TOUUD_REPR = "TOUUD"
...
TOLUD_DESCRIPTION = u"باید مقدار مجاز داشته باشد\nو حد پایینی دسترسی ها در \nMemory Remapping\n را مشخص کند." # use \n for newlines!
TOLUD_REPR = "TOLUD"
...
DPR_DESCRIPTION = u"در صورت فعال نبودن حمله \nکننده می تواند به آدرس\nهای  جازی غیر مجاز دسترسی داشته باشد." # use \n for newlines!
DPR_REPR = "DPR"
...
MESEG_MASK_DESCRIPTION = u"به علت آن که \nME\n در حلقه -2 قرار دارد بسیار حیاتی است \nمحدوده های تعیین شده توسط آن\n مقدار صحیح داشته باشند.\n همچنین برنامه های کاربر نباید در\nمحدوده های غیرمجاز قرار گیرند." # use \n for newlines!
...
REMAPBASE_DESCRIPTION = u"درصورتی که \nBase\n مقدار صحیحی نداشته باشد حمله\n کننده به اطلاعات حساسی نظیر \nSMRAM\n دسترسی پیدا می کند." # use \n for newlines!
...
REMAPLIMIT_DESCRIPTION = u"درصورتی که \nLimit\n مقدار صحیحی نداشته باشد حمله\n کننده به اطلاعات حساسی نظیر \nSMRAM\n دسترسی پیدا می کند." # use \n for newlines!
...
TOLUD_2_DESCRIPTION = u"باید مقدار مجاز داشته باشد و\n حد پایینی دسترسی ها در \nMemory Remapping\n را مشخص کند." # use \n for newlines!
TOLUD_2_REPR = "TOLUD"
...
TOM_DESCRIPTION = u"اگر این آدرس تغییر کند\n ME\n به اطلاعات مورد\n نیازش دسترسی نخواهد داشت." # use \n for newlines!
TOM_REPR = "TOM"
...
TOUUD_2_DESCRIPTION = u"باید مقدار مجاز داشته باشد\n و حد بالایی دسترسی ها در\n Memory Remapping\n را مشخص کند." # use \n for newlines!
TOUUD_2_REPR = "TOUUD"
...
TSEGMB_DESCRIPTION = u"آدرس شروع ناحیه \nTSEG\n نباید تغییر کند." # use \n for newlines!
TSEGMB_REPR = "TSEGMB"
...
TSEG_1_DESCRIPTION = u"مقدار شروع و پایان این ثبات باید با مقدار شروع و پایان \nTSEG\n برابر باشد.\n در صورتی که مقادیر متفاوت باشند احتمال بروز حملات \nDMA\n وجود دارد و حمله کننده می تواند به کل یا بخشی از اطلاعات \nSMRAM\n دسترسی پیدا کند."
TSEG_1_REPR = "TSEG"
...
SMRR_Range_DESCRIPTION = u"مقدار شروع و پایان این ثبات باید با مقدار شروع و پایان \nTSEG\n برابر باشد.\n در صورتی که مقادیر متفاوت باشند احتمال بروز حملات \nDMA\n وجود دارد و حمله کننده می تواند به کل یا بخشی از اطلاعات \nSMRAM\n دسترسی پیدا کند."
